...
def iniciar():
	...
	layout = [[sg.Text("")],
			  ...
			  [sg.Text("E:  "),sg.Input(key="E",size=(5,5)),sg.Text("     "),sg.Text("N: "),sg.Input(key="N",size=(5,5)),sg.Text("     "),sg.Text("V:    "),sg.Input(key="V",size=(5,5)),sg.Text("SELECIONE TIEMPO: "),sg.Input(key="-TIEMPO-")],
			  [sg.Text("F:  "),sg.Input(key="F",size=(5,5)),sg.Text("     "),sg.Text("Ñ: "),sg.Input(key="Ñ",size=(5,5)),sg.Text("     "),sg.Text("W:   "),sg.Input(key="W",size=(5,5)),sg.Text("   (En minutos)")],
